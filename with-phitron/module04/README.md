...
<table>
  ...
  <tr>
    <td> <!-- markdown-math-utilities-ignore -->```math a_{0,1}(z) \equiv \begin{cases} 1, & \text{, if}\; z \geq 0 \\ 0, &\text{, if}\; z < 0\end{cases}```
    </td>
...
$$</td>
  ...
  <tr>
    <th>Loss Function</th>
    <td><!-- markdown-math-utilities-ignore -->$$L_{W, b}(x)\equiv \left( y- \hat{y} \right)z$$</td>
